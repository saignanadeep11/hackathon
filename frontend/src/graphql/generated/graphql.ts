...
export type ActivityLogType = 'ALLOCATION' | 'AUDIT' | 'BOOKING' | 'MAINTENANCE';
...
export type AllocationStatus = 'ACTIVE' | 'APPROVED' | 'REJECTED' | 'REQUESTED' | 'RETURNED';
...
export type AssetStatus =
  'ALLOCATED' | 'AVAILABLE' | 'DISPOSED' | 'LOST' | 'RESERVED' | 'RETIRED' | 'UNDER_MAINTENANCE';
...
export type BookingStatus = 'CANCELLED' | 'COMPLETED' | 'ONGOING' | 'UPCOMING';
...
export type GetAllocationsQuery = {
  allocations: Array<{
    ...
    asset: { id: string; asset_tag: string; name: string; status: AssetStatus };
    allocated_to_user: { id: string; name: string; email: string } | null;
    allocated_to_department: { id: string; name: string } | null;
...
export type RequestAllocationMutation = {
  requestAllocation: { id: string; asset_id: string; status: AllocationStatus };
};
...
export type ApproveAllocationMutation = {
  approveAllocation: { id: string; status: AllocationStatus };
};
...
export type RejectAllocationMutation = {
  rejectAllocation: { id: string; status: AllocationStatus };
};
...
export type ReturnAssetMutation = {
  returnAsset: { id: string; status: AllocationStatus; return_date: unknown };
};
...
export type GetCategoriesQuery = {
  categories: Array<{ id: string; name: string; custom_fields_schema: string }>;
};
...
export type RegisterAssetMutation = {
  registerAsset: { id: string; asset_tag: string; name: string };
};
...
export type LoginMutation = {
  login: {
    accessToken: string;
    user: { id: string; name: string; email: string; role: UserRole; status: GeneralStatus };
  };
};
...
export type MeQuery = {
  me: { id: string; name: string; email: string; role: UserRole; status: GeneralStatus } | null;
};
...
export type GetBookingsQuery = {
  bookings: Array<{
    ...
    asset: { id: string; name: string; asset_tag: string; location: string };
    booked_by_user: { id: string; name: string; email: string };
  }>;
};

export type GetBookableAssetsQueryVariables = Exact<{ [key: string]: never }>;

export type GetBookableAssetsQuery = {
  bookableAssets: Array<{
    id: string;
    name: string;
    asset_tag: string;
    location: string;
...
export type CreateBookingMutation = {
  createBooking: { id: string; start_time: unknown; end_time: unknown; status: BookingStatus };
};
...
export type CreateCategoryMutation = {
  createCategory: { id: string; name: string; custom_fields_schema: string };
};
...
export type GetCategoriesPageQuery = {
  categoriesPage: {
    ...
    edges: Array<{
      cursor: string;
      node: { id: string; name: string; custom_fields_schema: string };
    }>;
  };
};
...
export type UpdateCategoryMutation = {
  updateCategory: { id: string; name: string; custom_fields_schema: string };
};
...
export type GetDepartmentsPageQuery = {
  departmentsPage: {
    totalCount: number;
    pageInfo: {
      hasNextPage: boolean;
...
export type UpdateDepartmentStatusMutation = {
  updateDepartmentStatus: { id: string; status: GeneralStatus };
};
...
export type AssignDepartmentHeadMutation = {
  assignDepartmentHead: { id: string; head: { id: string; name: string } | null };
};
...
export type CreateDepartmentMutation = {
  createDepartment: { id: string; name: string; status: GeneralStatus };
};
      ...
      variableDefinitions: [
        {
          ...
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'AllocationFilterInput' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'asset_id' } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'asset_tag' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'name' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                    ],
                  },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'allocated_to_user_id' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'allocated_to_user' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'allocated_to_department_id' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'allocated_to_department' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'requested_by_id' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'requested_by' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'return_date' } },
                { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                { kind: 'Field', name: { kind: 'Name', value: 'check_in_notes' } },
              ],
            },
          },
        ],
...
export const RequestAllocationDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RequestAllocation' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateAllocationInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<RequestAllocationMutation, RequestAllocationMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ApproveAllocation' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<ApproveAllocationMutation, ApproveAllocationMutationVariables>;
export const RejectAllocationDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RejectAllocation' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<RejectAllocationMutation, RejectAllocationMutationVariables>;
export const ReturnAssetDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ReturnAsset' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'check_in_notes' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'check_in_notes' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'check_in_notes' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<ReturnAssetMutation, ReturnAssetMutationVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'acquisition_date' } },
                { kind: 'Field', name: { kind: 'Name', value: 'acquisition_cost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'condition' } },
                { kind: 'Field', name: { kind: 'Name', value: 'location' } },
                { kind: 'Field', name: { kind: 'Name', value: 'is_shared_bookable' } },
                { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                { kind: 'Field', name: { kind: 'Name', value: 'custom_fields_data' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                { kind: 'Field', name: { kind: 'Name', value: 'name' } },
                { kind: 'Field', name: { kind: 'Name', value: 'custom_fields_schema' } },
              ],
            },
          },
        ],
...
export const RegisterAssetDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RegisterAsset' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RegisterAssetInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<RegisterAssetMutation, RegisterAssetMutationVariables>;
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'BookingFilterInput' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'booked_by_user_id' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'booked_by_user' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetBookableAssetsQuery, GetBookableAssetsQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateBookingInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'totalAssets' } },
                { kind: 'Field', name: { kind: 'Name', value: 'availableAssets' } },
                { kind: 'Field', name: { kind: 'Name', value: 'allocatedAssets' } },
                { kind: 'Field', name: { kind: 'Name', value: 'underMaintenanceAssets' } },
                { kind: 'Field', name: { kind: 'Name', value: 'pendingAllocationRequests' } },
                { kind: 'Field', name: { kind: 'Name', value: 'overdueAllocations' } },
                { kind: 'Field', name: { kind: 'Name', value: 'upcomingBookingsToday' } },
                { kind: 'Field', name: { kind: 'Name', value: 'totalBookings' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'recentActivityLogs' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'ActivityLogFilterInput' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<GetActivityLogsQuery, GetActivityLogsQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'customFieldsSchema' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
          },
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'customFieldsSchema' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'CategoryFilterInput' } },
        },
        {
          kind: 'VariableDefinition',
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'cursor' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'custom_fields_schema' },
                            },
                          ],
                        },
                      },
...
} as unknown as DocumentNode<GetCategoriesPageQuery, GetCategoriesPageQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetDepartmentsPage' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'DepartmentFilterInput' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'first' } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'departmentsPage' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'filter' },
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'cursor' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'parent_department' },
                              selectionSet: {
                                kind: 'SelectionSet',
                                selections: [
                                  { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetDepartmentsPageQuery, GetDepartmentsPageQueryVariables>;
export const GetUsersPageDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'usersPage' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'filter' },
...
} as unknown as DocumentNode<GetUsersPageQuery, GetUsersPageQueryVariables>;
...
export const PromoteToAdminDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'PromoteToAdmin' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<PromoteToAdminMutation, PromoteToAdminMutationVariables>;
export const PromoteToDeptHeadDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'PromoteToDeptHead' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<PromoteToDeptHeadMutation, PromoteToDeptHeadMutationVariables>;
export const UpdateDepartmentStatusDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateDepartmentStatus' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
        ...
        },
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'GeneralStatus' } },
          },
        },
      ],
      selectionSet: {
  ...
  UpdateDepartmentStatusMutation,
  UpdateDepartmentStatusMutationVariables
>;
export const AssignDepartmentHeadDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'AssignDepartmentHead' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'head_id' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
          },
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'head_id' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'head_id' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<AssignDepartmentHeadMutation, AssignDepartmentHeadMutationVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'parent_department_id' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'parent_department_id' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
