 ...
 */
type Documents = {
  'query GetAllocations($filter: AllocationFilterInput) {\n  allocations(filter: $filter) {\n    id\n    asset_id\n    asset {\n      id\n      asset_tag\n      name\n      status\n    }\n    allocated_to_user_id\n    allocated_to_user {\n      id\n      name\n      email\n    }\n    allocated_to_department_id\n    allocated_to_department {\n      id\n      name\n    }\n    requested_by_id\n    requested_by {\n      id\n      name\n      email\n    }\n    expected_return_date\n    return_date\n    status\n    check_in_notes\n  }\n}\n\nmutation RequestAllocation($input: CreateAllocationInput!) {\n  requestAllocation(input: $input) {\n    id\n    asset_id\n    status\n  }\n}\n\nmutation ApproveAllocation($id: String!) {\n  approveAllocation(id: $id) {\n    id\n    status\n  }\n}\n\nmutation RejectAllocation($id: String!) {\n  rejectAllocation(id: $id) {\n    id\n    status\n  }\n}\n\nmutation ReturnAsset($id: String!, $check_in_notes: String) {\n  returnAsset(id: $id, check_in_notes: $check_in_notes) {\n    id\n    status\n    return_date\n  }\n}': typeof types.GetAllocationsDocument;
  ...
  'query GetDepartmentsPage($filter: DepartmentFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  departmentsPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        status\n        head {\n          id\n          name\n          email\n        }\n        parent_department {\n          id\n          name\n        }\n      }\n    }\n  }\n}\n\nquery GetUsersPage($filter: UserFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  usersPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        email\n        role\n        status\n        department {\n          id\n          name\n        }\n      }\n    }\n  }\n}': typeof types.GetDepartmentsPageDocument;
...
const documents: Documents = {
  ...
  'query GetDepartmentsPage($filter: DepartmentFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  departmentsPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        status\n        head {\n          id\n          name\n          email\n        }\n        parent_department {\n          id\n          name\n        }\n      }\n    }\n  }\n}\n\nquery GetUsersPage($filter: UserFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  usersPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        email\n        role\n        status\n        department {\n          id\n          name\n        }\n      }\n    }\n  }\n}':
    types.GetDepartmentsPageDocument,
  '\n  query GetDepartments {\n    departments {\n      id\n      name\n      status\n      head {\n        id\n        name\n      }\n      parent_department {\n        id\n        name\n      }\n    }\n  }\n':
...
export function graphql(
  source: 'query GetAllocations($filter: AllocationFilterInput) {\n  allocations(filter: $filter) {\n    id\n    asset_id\n    asset {\n      id\n      asset_tag\n      name\n      status\n    }\n    allocated_to_user_id\n    allocated_to_user {\n      id\n      name\n      email\n    }\n    allocated_to_department_id\n    allocated_to_department {\n      id\n      name\n    }\n    requested_by_id\n    requested_by {\n      id\n      name\n      email\n    }\n    expected_return_date\n    return_date\n    status\n    check_in_notes\n  }\n}\n\nmutation RequestAllocation($input: CreateAllocationInput!) {\n  requestAllocation(input: $input) {\n    id\n    asset_id\n    status\n  }\n}\n\nmutation ApproveAllocation($id: String!) {\n  approveAllocation(id: $id) {\n    id\n    status\n  }\n}\n\nmutation RejectAllocation($id: String!) {\n  rejectAllocation(id: $id) {\n    id\n    status\n  }\n}\n\nmutation ReturnAsset($id: String!, $check_in_notes: String) {\n  returnAsset(id: $id, check_in_notes: $check_in_notes) {\n    id\n    status\n    return_date\n  }\n}',
): (typeof documents)['query GetAllocations($filter: AllocationFilterInput) {\n  allocations(filter: $filter) {\n    id\n    asset_id\n    asset {\n      id\n      asset_tag\n      name\n      status\n    }\n    allocated_to_user_id\n    allocated_to_user {\n      id\n      name\n      email\n    }\n    allocated_to_department_id\n    allocated_to_department {\n      id\n      name\n    }\n    requested_by_id\n    requested_by {\n      id\n      name\n      email\n    }\n    expected_return_date\n    return_date\n    status\n    check_in_notes\n  }\n}\n\nmutation RequestAllocation($input: CreateAllocationInput!) {\n  requestAllocation(input: $input) {\n    id\n    asset_id\n    status\n  }\n}\n\nmutation ApproveAllocation($id: String!) {\n  approveAllocation(id: $id) {\n    id\n    status\n  }\n}\n\nmutation RejectAllocation($id: String!) {\n  rejectAllocation(id: $id) {\n    id\n    status\n  }\n}\n\nmutation ReturnAsset($id: String!, $check_in_notes: String) {\n  returnAsset(id: $id, check_in_notes: $check_in_notes) {\n    id\n    status\n    return_date\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetAssets($filter: AssetFilterInput) {\n  assets(filter: $filter) {\n    id\n    asset_tag\n    name\n    serial_number\n    acquisition_date\n    acquisition_cost\n    condition\n    location\n    is_shared_bookable\n    status\n    custom_fields_data\n    photo_url\n    createdAt\n    category {\n      id\n      name\n    }\n  }\n}\n\nquery GetCategories {\n  categories {\n    id\n    name\n    custom_fields_schema\n  }\n}\n\nmutation RegisterAsset($input: RegisterAssetInput!) {\n  registerAsset(input: $input) {\n    id\n    asset_tag\n    name\n  }\n}',
 ...
 */
export function graphql(
  source: 'query GetBookings($filter: BookingFilterInput) {\n  bookings(filter: $filter) {\n    id\n    asset_id\n    asset {\n      id\n      name\n      asset_tag\n      location\n    }\n    booked_by_user_id\n    booked_by_user {\n      id\n      name\n      email\n    }\n    start_time\n    end_time\n    status\n  }\n}\n\nquery GetBookableAssets {\n  bookableAssets {\n    id\n    name\n    asset_tag\n    location\n    status\n  }\n}\n\nmutation CreateBooking($input: CreateBookingInput!) {\n  createBooking(input: $input) {\n    id\n    start_time\n    end_time\n    status\n  }\n}\n\nmutation CancelBooking($id: String!) {\n  cancelBooking(id: $id) {\n    id\n    status\n  }\n}',
): (typeof documents)['query GetBookings($filter: BookingFilterInput) {\n  bookings(filter: $filter) {\n    id\n    asset_id\n    asset {\n      id\n      name\n      asset_tag\n      location\n    }\n    booked_by_user_id\n    booked_by_user {\n      id\n      name\n      email\n    }\n    start_time\n    end_time\n    status\n  }\n}\n\nquery GetBookableAssets {\n  bookableAssets {\n    id\n    name\n    asset_tag\n    location\n    status\n  }\n}\n\nmutation CreateBooking($input: CreateBookingInput!) {\n  createBooking(input: $input) {\n    id\n    start_time\n    end_time\n    status\n  }\n}\n\nmutation CancelBooking($id: String!) {\n  cancelBooking(id: $id) {\n    id\n    status\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetDashboardMetrics {\n  dashboardMetrics {\n    totalAssets\n    availableAssets\n    allocatedAssets\n    underMaintenanceAssets\n    pendingAllocationRequests\n    overdueAllocations\n    upcomingBookingsToday\n    totalBookings\n    recentActivityLogs {\n      id\n      type\n      message\n      is_read\n      created_at\n      actor {\n        id\n        name\n      }\n    }\n  }\n}',
): (typeof documents)['query GetDashboardMetrics {\n  dashboardMetrics {\n    totalAssets\n    availableAssets\n    allocatedAssets\n    underMaintenanceAssets\n    pendingAllocationRequests\n    overdueAllocations\n    upcomingBookingsToday\n    totalBookings\n    recentActivityLogs {\n      id\n      type\n      message\n      is_read\n      created_at\n      actor {\n        id\n        name\n      }\n    }\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetActivityLogs($filter: ActivityLogFilterInput) {\n  activityLogs(filter: $filter) {\n    id\n    type\n    message\n    is_read\n    created_at\n    actor {\n      id\n      name\n    }\n  }\n}\n\nquery GetUnreadNotificationCount {\n  unreadNotificationCount\n}\n\nmutation MarkAllNotificationsRead {\n  markAllNotificationsRead\n}',
): (typeof documents)['query GetActivityLogs($filter: ActivityLogFilterInput) {\n  activityLogs(filter: $filter) {\n    id\n    type\n    message\n    is_read\n    created_at\n    actor {\n      id\n      name\n    }\n  }\n}\n\nquery GetUnreadNotificationCount {\n  unreadNotificationCount\n}\n\nmutation MarkAllNotificationsRead {\n  markAllNotificationsRead\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation CreateCategory($name: String!, $customFieldsSchema: String!) {\n  createCategory(name: $name, customFieldsSchema: $customFieldsSchema) {\n    id\n    name\n    custom_fields_schema\n  }\n}\n\nquery GetCategoriesPage($filter: CategoryFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  categoriesPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        custom_fields_schema\n      }\n    }\n  }\n}\n\nmutation UpdateCategory($id: String!, $name: String, $customFieldsSchema: String) {\n  updateCategory(id: $id, name: $name, customFieldsSchema: $customFieldsSchema) {\n    id\n    name\n    custom_fields_schema\n  }\n}',
): (typeof documents)['mutation CreateCategory($name: String!, $customFieldsSchema: String!) {\n  createCategory(name: $name, customFieldsSchema: $customFieldsSchema) {\n    id\n    name\n    custom_fields_schema\n  }\n}\n\nquery GetCategoriesPage($filter: CategoryFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  categoriesPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        custom_fields_schema\n      }\n    }\n  }\n}\n\nmutation UpdateCategory($id: String!, $name: String, $customFieldsSchema: String) {\n  updateCategory(id: $id, name: $name, customFieldsSchema: $customFieldsSchema) {\n    id\n    name\n    custom_fields_schema\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query GetDepartmentsPage($filter: DepartmentFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  departmentsPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        status\n        head {\n          id\n          name\n          email\n        }\n        parent_department {\n          id\n          name\n        }\n      }\n    }\n  }\n}\n\nquery GetUsersPage($filter: UserFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  usersPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        email\n        role\n        status\n        department {\n          id\n          name\n        }\n      }\n    }\n  }\n}',
): (typeof documents)['query GetDepartmentsPage($filter: DepartmentFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  departmentsPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        status\n        head {\n          id\n          name\n          email\n        }\n        parent_department {\n          id\n          name\n        }\n      }\n    }\n  }\n}\n\nquery GetUsersPage($filter: UserFilterInput, $first: Float, $after: String, $last: Float, $before: String) {\n  usersPage(\n    filter: $filter\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n  ) {\n    totalCount\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        id\n        name\n        email\n        role\n        status\n        department {\n          id\n          name\n        }\n      }\n    }\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
